...
​        这个程序的最初目的是：自己偶尔需要在两台电脑之间传送一些文件或者消息或者截图，因为不太喜欢用电脑版微信，也不喜欢装其他软件。

​        后来改着改着变成支持多人共享了，只要局域网内IP能互通，一个人运行下这个python文件，其他人可以方便通过电脑浏览器或者手机扫码登录到同一个房间或者叫工作区进行交流、传送信息和工作文件及截图。
